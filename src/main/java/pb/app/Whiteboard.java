...
public class Whiteboard {
    ...
    /**
     * Whether this whiteboard has been selected as a shown board
     */
    private boolean hasbeenchossed = false;

    public ArrayList<Endpoint> beListenedEndpoints =new ArrayList<>();

    public boolean getUsed() {
        return this.hasbeenchossed;
    }

    public void setUsed() {
        this.hasbeenchossed = true;
    }
	...
	public void setVersion(long thisversion){
